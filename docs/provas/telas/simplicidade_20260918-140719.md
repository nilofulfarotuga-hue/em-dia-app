# Juiz de simplicidade — 20260918-140719

Pergunta feita ao Gemini por cada ecrã: **«Uma pessoa que nunca usou uma app destas percebe o que fazer aqui?»** — resposta literal guardada. Fotos: 111 · {'verde': 46, 'amarelo': 60, 'vermelho': 5, 'erro': 0} (verde = sim, amarelo = quase, vermelho = não).

## caixa_desligada_medio_pt.png — quase
...
- Melhoria: Incluir um botão de ação direta para comprar ou configurar o endereço, ou explicar claramente se essa compra é automática por parte da plataforma.
...
- Melhoria: Corrigir o erro visual do texto cortado no topo e alterar 'Fazer conta com esta' para algo mais explícito como 'Registar despesa'.
- Modelo: gemini-3.5-flash

## caixa_ligada_medio_pt.png — sim
...
- Palavras difíceis: Fazer conta
- Melhoria: Substituir 'Fazer conta com esta' por um termo mais preciso como 'Registar despesa' ou 'Associar à atividade'.
- Modelo: gemini-3.5-flash

## caixa_vazia_medio_pt.png — quase
...
- Melhoria: Adicionar um botão direto para partilhar o endereço por e-mail ou WhatsApp.
- Modelo: gemini-flash-lite-latest

## calendario_detalhe_medio_pt.png — quase
...
- Melhoria: Adicionar um botão direto para gerar a referência ou simplificar os passos de pagamento com imagens.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar um botão de ação rápida para pagar ou marcar como pago diretamente em cada item da lista.
- Modelo: gemini-flash-lite-latest

## carro_abastecimentos_medio_pt.png — quase
...
- Melhoria: Adicionar uma breve frase explicativa no topo a indicar para que servem estes registos na contabilidade.
- Modelo: gemini-flash-lite-latest

## carro_cadeado_medio_pt.png — quase
...
- Melhoria: Adicionar um botão direto para atualizar o plano ou explicar melhor o que limita a versão gratuita.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Explicar numa frase simples o que significa guardar faturas para o IRS neste contexto.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar botões de ação claros em cada lembrete, como 'Marcar como pago' ou 'Ver detalhes'.
- Modelo: gemini-flash-lite-latest

## carro_perto_medio_pt.png — sim
...
- Melhoria: Tornar o texto introdutório mais curto para focar imediatamente a atenção nos botões de ação.
- Modelo: gemini-flash-lite-latest

## carro_perto_sem_permissao_medio_pt.png — sim
...
- Melhoria: Adicionar um exemplo prático na caixa de texto, como por exemplo 'Ex: Lisboa'.
- Modelo: gemini-flash-lite-latest

## carro_perto_vazio_medio_pt.png — sim
...
- Palavras difíceis: concelho
- Melhoria: Reduzir a quantidade de texto explicativo para tornar o ecrã mais limpo e direto.
- Modelo: gemini-flash-lite-latest

## carro_vazio_medio_pt.png — sim
...
- Melhoria: Explicar brevemente o significado de DGEG e IMT ou remover as siglas para tornar o texto mais acessível a leigos.
- Modelo: gemini-flash-lite-latest

## cofre_a_carregar_medio_pt.png — nao
...
- Melhoria: Adicionar uma breve explicação sobre o propósito do ecrã e um botão claro a indicar a próxima ação.
- Modelo: gemini-flash-lite-latest

## cofre_caderno_medio_pt.png — quase
...
- Melhoria: Adicionar uma breve explicação por baixo dos botões a indicar claramente o que acontece ao carregar neles.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar uma breve explicação por baixo dos botões 'Separei' e 'Tirei' a indicar quando devem ser utilizados.
- Modelo: gemini-flash-lite-latest

## cofre_erro_medio_pt.png — sim
...
- Melhoria: Adicionar um ícone ou indicação visual para verificar o Wi-Fi ou dados móveis.
- Modelo: gemini-flash-lite-latest

## cofre_falta_muito_medio_pt.png — quase
...
- Palavras difíceis: Segurança Social, IRS
- Melhoria: Adicionar um botão explicativo com a indicação exata de quanto deve guardar da próxima vez que receber.
- Modelo: gemini-flash-lite-latest

## cofre_falta_pouco_medio_pt.png — quase
...
- Melhoria: Adicionar uma explicação curta sobre o que significam 'Segurança Social' e 'IRS' para quem nunca lidou com impostos.
- Modelo: gemini-flash-lite-latest

## cofre_folha_medio_pt.png — quase
...
- Palavras difíceis: IRS, Segurança Social
- Melhoria: Adicionar um exemplo prático no campo vazio para indicar que valor deve ser inserido.
- Modelo: gemini-flash-lite-latest

## cofre_sem_sessao_medio_pt.png — quase
...
- Melhoria: Transformar a caixa azul num botão bem visível com o texto "Entrar na aplicação".
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar uma breve instrução passo a passo a explicar a diferença entre indicar o que ganhou e mexer no dinheiro do cofre.
- Modelo: gemini-flash-lite-latest

## conta-nao-abriu_medio_pt.png — sim
...
- Melhoria: Adicionar uma breve explicação ou exemplo do que é o modelo RP5044 para facilitar a compreensão.
- Modelo: gemini-flash-lite-latest

## exemplo_carro_medio_pt.png — quase
...
- Palavras difíceis: TVDE, IUC
- Melhoria: Adicionar um botão direto em cada lembrete para 'Marcar no calendário' ou 'Saber como pagar'.
- Modelo: gemini-flash-lite-latest

## exemplo_painel_medio_pt.png — sim
...
- Palavras difíceis: Segurança Social, IRS
- Melhoria: Adicionar um pequeno texto explicativo a indicar que ao clicar em "Ver como pagar" aparecem as referências para o multibanco.
- Modelo: gemini-flash-lite-latest

## exemplo_vida_medio_pt.png — sim
...
- Melhoria: Adicionar um pequeno texto a explicar se os ganhos foram importados automaticamente ou inseridos manualmente.
- Modelo: gemini-flash-lite-latest

## fala_a_ouvir_medio_pt.png — quase
...
- Melhoria: Adicionar uma instrução visual a indicar se deve manter o dedo premido ou apenas tocar uma vez.
- Modelo: gemini-flash-lite-latest

## fala_a_pensar_medio_pt.png — sim
...
- Melhoria: Adicionar uma animação mais clara de que o sistema está apenas a processar o áudio para evitar a sensação de bloqueio.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar botões de ação rápida logo abaixo da resposta, como "Como pagar?" ou "Adicionar lembrete".
- Modelo: gemini-flash-lite-latest

## fala_escrita_medio_pt.png — sim
...
- Melhoria: Adicionar um botão direto para ligar o microfone nas definições dentro do próprio ecrã.
- Modelo: gemini-flash-lite-latest

## fala_limite_medio_pt.png — quase
...
- Melhoria: Tornar o botão do microfone cinzento e inativo quando acabarem as perguntas, indicando claramente que é preciso atualizar o plano.
- Modelo: gemini-flash-lite-latest

## fala_parado_medio_pt.png — sim
...
- Palavras difíceis: IVA
- Melhoria: Adicionar uma breve animação ou indicação visual a apontar diretamente para o botão do microfone para atrair imediatamente o olhar.
- Modelo: gemini-flash-lite-latest

## fala_sem_microfone_medio_pt.png — quase
...
- Palavras difíceis: IVA
- Melhoria: Adicionar um botão direto para abrir as definições do telemóvel e ligar o microfone.
- Modelo: gemini-flash-lite-latest

## fala_sem_rede_medio_pt.png — quase
...
- Palavras difíceis: IVA
- Melhoria: Adicionar um botão claro para tentar ligar novamente a internet e explicar como resolver o erro de rede.
- Modelo: gemini-flash-lite-latest

## fala_trancado_medio_pt.png — quase
...
- Melhoria: Tornar o botão de ativação do Pro mais claro ou explicar o que é necessário fazer para desbloquear o assistente de voz.
- Modelo: gemini-flash-lite-latest

## guias_breve_medio_pt.png — quase
...
- Melhoria: Adicionar uma estimativa de tempo para a disponibilidade do guia ou um botão para voltar atrás.
- Modelo: gemini-flash-lite-latest

## guias_detalhe_medio_pt.png — quase
...
- Melhoria: Adicionar um botão direto para abrir o portal da Segurança Social no navegador do telemóvel.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar uma breve frase de boas-vindas a explicar qual o primeiro guia que o utilizador deve ler consoante a sua situação.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar uma breve explicação em linguagem simples sobre o impacto prático de ativar o botão das 100 horas extra.
- Modelo: gemini-flash-lite-latest

## ia_limite_medio_pt.png — quase
...
- Melhoria: Tornar a caixa de texto inferior claramente desativada com um aviso direto para carregar em 'Ver o plano Pro'.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar um botão direto para simular a criação dessa poupança ou calcular o valor exato com base nos rendimentos reais.
- Modelo: gemini-flash-lite-latest

## ia_pensar_medio_pt.png — quase
...
- Melhoria: Adicionar botões de ação rápida abaixo da resposta com os próximos passos recomendados para o utilizador.
- Modelo: gemini-flash-lite-latest

## ia_vazio_medio_pt.png — sim
...
- Melhoria: Adicionar uma breve instrução no topo a incentivar o utilizador a escrever a sua própria questão por palavras simples.
- Modelo: gemini-flash-lite-latest

## login-codigo_medio_pt.png — sim
...
- Melhoria: Adicionar um botão direto para abrir a aplicação de e-mail do telemóvel.
- Modelo: gemini-flash-lite-latest

## login_medio_pt.png — sim
...
## mais_definicoes_medio_pt.png — sim
...
- Melhoria: Adicionar uma breve descrição ou subtítulo abaixo de cada título que explique a utilidade prática de cada opção.
...
- Melhoria: Adicionar um pequeno botão de ajuda ou 'i' junto a cada opção que explique de forma simples o que significa cada uma.
- Modelo: gemini-3.1-flash-lite

## onboarding_iva_periodo_medio_pt.png — sim
...
- Palavras difíceis: IVA
- Melhoria: Adicionar uma breve explicação sobre o que é o IVA ou um link para 'Saber mais' para reduzir a ansiedade do utilizador.
- Modelo: gemini-3.1-flash-lite

## onboarding_nascimento_medio_pt.png — sim
...
- Melhoria: Adicionar um pequeno ícone de ajuda ou um link 'Saber mais' junto à explicação do IRS Jovem para esclarecer o conceito sem sair do fluxo.
- Modelo: gemini-3.1-flash-lite

## onboarding_p0_boasvindas_medio_pt.png — sim
...
- Palavras difíceis: IVA, IRS
- Melhoria: Adicionar uma pequena frase de apoio como 'Não te preocupes, vamos ajudar-te com cada passo' para reduzir a ansiedade fiscal.
- Modelo: gemini-3.1-flash-lite

## onboarding_p1_atividade_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena descrição ou exemplo por baixo de 'Motorista TVDE' para esclarecer que se trata de transporte de passageiros.
- Modelo: gemini-3.1-flash-lite
...
- Melhoria: Adicionar um pequeno botão ou link de ajuda que mostre um exemplo visual de onde encontrar a data de início de atividade no documento das Finanças.
- Modelo: gemini-3.1-flash-lite

## onboarding_p4_carro_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena nota explicativa ou um ícone de ajuda junto à sigla IUC para esclarecer que se trata do Imposto Único de Circulação.
- Modelo: gemini-3.1-flash-lite

## onboarding_p5_rendimento_medio_pt.png — sim
...
- Palavras difíceis: IRS, Segurança Social
- Melhoria: Adicionar uma pequena nota a esclarecer se o valor a inserir deve ser o rendimento bruto ou líquido.
- Modelo: gemini-3.1-flash-lite

## onboarding_salario_medio_pt.png — sim
...
- Melhoria: Adicionar um pequeno texto de ajuda ou um ícone de informação a explicar se o valor deve incluir subsídios de alimentação ou outros complementos.
- Modelo: gemini-3.1-flash-lite

## onboarding_trabalho_medio_pt.png — sim
...
- Palavras difíceis: TVDE
- Melhoria: Adicionar uma pequena explicação ou o significado completo da sigla TVDE (Transporte Individual e Remunerado de Passageiros em Veículos Descaracterizados a partir de Plataforma Eletrónica) num pequeno texto de ajuda.
- Modelo: gemini-3.1-flash-lite

## painel_erro_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena sugestão visual ou texto a indicar que deve verificar a ligação à internet do telemóvel.
- Modelo: gemini-3.1-flash-lite

## painel_laranja_medio_pt.png — sim
...
- Palavras difíceis: IUC
- Melhoria: Adicionar um pequeno ícone de ajuda ou um texto explicativo mais detalhado sobre o que acontece ao clicar em 'Já paguei' para evitar receio de erro.
- Modelo: gemini-3.1-flash-lite

## painel_skeleton_medio_pt.png — nao
...
- Melhoria: Adicionar um botão de ação claro, como 'Adicionar o meu primeiro recibo' ou 'Configurar perfil', no centro do ecrã vazio.
- Modelo: gemini-3.1-flash-lite

## painel_verde_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena nota explicativa no botão ou abaixo dele a esclarecer se o valor a inserir deve ser o rendimento bruto ou líquido.
- Modelo: gemini-3.1-flash-lite

## painel_vermelho_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena frase explicativa abaixo de 'Ver como pagar' indicando que o botão apenas mostra os dados para pagamento e não retira dinheiro da conta.
- Modelo: gemini-3.1-flash-lite

## painel_vermelho_segunda_medio_pt.png — sim
...
- Melhoria: Adicionar a indicação do período ou mês a que corresponde o pagamento em falta da Segurança Social.
- Modelo: gemini-3.5-flash

## plano_gratis_medio_pt.png — sim
...
- Melhoria: Adicionar um botão de fechar (X) ou 'Voltar' para que o utilizador saiba como sair deste ecrã sem subscrever.
- Modelo: gemini-3.5-flash
...
- Melhoria: Adicionar uma frase curta a indicar exatamente onde será feito o pagamento (ex: 'Pagamento seguro através da App Store').
- Modelo: gemini-flash-lite-latest

## prova_com_dados_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena frase a explicar o que é o NIF para quem possa ter dúvidas.
- Modelo: gemini-flash-lite-latest

## prova_sem_dados_medio_pt.png — quase
...
- Melhoria: Adicionar um botão direto para adicionar os meses em falta logo abaixo do aviso a laranja.
- Modelo: gemini-flash-lite-latest

## prova_trancada_medio_pt.png — quase
...
- Melhoria: Adicionar uma explicação simples sobre o que é necessário para desbloquear o plano Pro logo abaixo do aviso do cadeado.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar um botão direto para a secção 'Dinheiro' logo abaixo do aviso para facilitar o registo imediato dos ganhos.
- Modelo: gemini-flash-lite-latest

## radar_erro_medio_pt.png — quase
...
- Melhoria: Adicionar um botão de 'Tentar novamente' na caixa de erro para facilitar a nova tentativa.
- Modelo: gemini-flash-lite-latest

## radar_lista_fim_medio_pt.png — quase
...
- Melhoria: Adicionar botões de ação direta em cada cartão, como "Já renegociei" ou "Ligar agora".
- Modelo: gemini-flash-lite-latest

## radar_lista_medio_pt.png — sim
...
- Melhoria: Tornar os cartões dos contratos clicáveis para ver mais detalhes ou adicionar um botão direto para ligar ou enviar mensagem.
- Modelo: gemini-flash-lite-latest

## radar_trancado_medio_pt.png — sim
...
- Melhoria: Adicionar um botão direto para adicionar o primeiro contrato logo abaixo da explicação.
- Modelo: gemini-flash-lite-latest

## radar_vazio_medio_pt.png — quase
...
- Palavras difíceis: fidelização
- Melhoria: Adicionar um botão bem visível no fundo com o texto 'Adicionar contrato' para orientar o utilizador.
- Modelo: gemini-flash-lite-latest

## recibo_vencimento_medio_pt.png — quase
...
- Palavras difíceis: IRS
- Melhoria: Adicionar uma pequena ajuda visual a indicar exatamente onde encontrar esses dois números no recibo de papel.
- Modelo: gemini-flash-lite-latest

## recibos_cartao_fatura_medio_pt.png — quase
...
- Palavras difíceis: PDF
- Melhoria: Adicionar um botão explícito como 'Criar fatura-recibo' para clarificar que a linha é interativa.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar botões de ação mais diretos para registar ou verificar documentos dentro da própria app.
- Modelo: gemini-flash-lite-latest

## recibos_emitir_medio_pt.png — quase
...
- Melhoria: Adicionar botões de atalho direto para os passos do Portal das Finanças sempre que possível, evitando que o utilizador tenha de navegar sozinho no site externo.
- Modelo: gemini-flash-lite-latest

## recibos_empresa_medio_pt.png — nao
...
- Melhoria: Adicionar botões de ação clara em cada item da lista (por exemplo, 'Enviar' ou 'Consultar') para orientar o utilizador sobre o próximo passo prático.
- Modelo: gemini-flash-lite-latest

## recibos_irs_medio_pt.png — quase
...
- Melhoria: Adicionar um botão ou indicação clara no fundo a explicar o próximo passo, como por exemplo 'Como pagar' ou 'Entendido'.
- Modelo: gemini-flash-lite-latest
...
- Melhoria: Adicionar uma pergunta inicial simples para preencher automaticamente as opções de retenção e IVA.
- Modelo: gemini-flash-lite-latest

## recibos_passar_fatura_medio_pt.png — quase
...
- Melhoria: Adicionar um pequeno ícone de ajuda ou um link 'O que é isto?' junto a cada termo técnico para explicar as consequências de cada escolha de forma simples.
- Modelo: gemini-3.1-flash-lite

## recibos_sem_fatura_medio_pt.png — quase
...
- Palavras difíceis: IVA, Retenção na fonte, art. 53.º
- Melhoria: Adicionar um pequeno botão de ajuda ou 'Não sei o que escolher' que explique de forma simples como verificar qual a taxa correta no portal das Finanças.
- Modelo: gemini-3.1-flash-lite

## recibos_ss_medio_pt.png — quase
...
- Melhoria: Adicionar um botão de ação claro no final de cada secção, como 'Ver histórico' ou 'Configurar pagamentos', para guiar o utilizador.
- Modelo: gemini-3.1-flash-lite

## reforma_cadeado_medio_pt.png — quase
...
- Melhoria: Adicionar um pequeno texto explicativo ou um link de 'Saber mais' que clarifique que estes dados são calculados com base no histórico real do utilizador ou se são apenas uma simulação hipotética.
- Modelo: gemini-3.1-flash-lite

## reforma_medio_pt.png — quase
...
- Melhoria: Adicionar um botão de 'Ver detalhes da minha carreira' ou 'Simular outro cenário' para dar continuidade à navegação.
- Modelo: gemini-3.1-flash-lite

## suporte_bug_medio_pt.png — sim
...
- Melhoria: Adicionar um botão ou indicação clara para 'Anexar captura de ecrã' para facilitar o diagnóstico do erro.
- Modelo: gemini-3.1-flash-lite

## suporte_medio_pt.png — sim
...
- Melhoria: Adicionar um botão de chat direto ou um ícone de 'Novo Pedido' mais visível para reforçar que é possível iniciar uma conversa nova.
- Modelo: gemini-3.1-flash-lite

## suporte_reembolso_medio_pt.png — quase
...
- Melhoria: Adicionar um pequeno passo a passo visual ou um link direto para o artigo de suporte da Google que explica como cancelar subscrições.
- Modelo: gemini-3.1-flash-lite

## suporte_vazio_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena nota a explicar que o assistente é um chat automático ou humano, para gerir expectativas.
- Modelo: gemini-3.1-flash-lite

## vale_falta_carro_medio_pt.png — sim
...
- Melhoria: Adicionar um botão ou link 'Onde encontro isto?' junto aos campos do carro que abra um pequeno guia visual ou exemplo.
- Modelo: gemini-3.1-flash-lite
...
- Melhoria: Adicionar um botão de ação claro no fundo, como 'Guardar esta viagem' ou 'Voltar ao início', para dar uma conclusão ao fluxo.
- Modelo: gemini-3.1-flash-lite

## vale_sobra_bem_medio_pt.png — sim
...
- Palavras difíceis: Segurança Social
- Melhoria: Adicionar um botão de 'Calcular' ou 'Ver resultado' para confirmar a ação, em vez de atualizar o ecrã automaticamente.
- Modelo: gemini-3.1-flash-lite

## vale_sobra_bem_resposta_medio_pt.png — quase
...
- Palavras difíceis: IRS, Segurança Social, Retenção
- Melhoria: Adicionar um botão de ação clara no final, como 'Guardar este registo', para confirmar a conclusão da tarefa.
- Modelo: gemini-3.1-flash-lite

## vale_vazio_medio_pt.png — sim
...
- Melhoria: Adicionar um botão de ação destacado no final do ecrã com o texto 'Calcular lucro' ou 'Ver resultado'.
- Modelo: gemini-3.1-flash-lite

## vida_detalhe_conta_medio_pt.png — sim
...
- Melhoria: Adicionar um botão de 'Confirmar pagamento' ou 'Já paguei' após a realização da operação para dar segurança ao utilizador.
- Modelo: gemini-3.1-flash-lite

## vida_entra_cheio_medio_pt.png — quase
...
- Melhoria: Adicionar um pequeno texto explicativo ou um ícone de ajuda que esclareça se o registo é manual ou automático.
- Modelo: gemini-3.1-flash-lite

## vida_entra_erro_medio_pt.png — sim
...
- Melhoria: Adicionar um botão de 'Tentar novamente' dentro da caixa de erro para facilitar a resolução do problema de ligação.
- Modelo: gemini-3.1-flash-lite

## vida_entra_vazio_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena nota informativa a explicar que este registo é apenas para controlo pessoal e não substitui a emissão de recibos verdes.
- Modelo: gemini-3.1-flash-lite

## vida_importar_extrato_medio_pt.png — quase
...
- Melhoria: Adicionar uma pequena frase explicativa abaixo do botão 'Guardar' que diga 'Isto apenas organiza os teus gastos na app, não altera nada nas Finanças'.
- Modelo: gemini-3.1-flash-lite

## vida_nova_entrada_medio_pt.png — sim
...
- Palavras difíceis: Recibo verde
- Melhoria: Adicionar uma pequena nota de ajuda abaixo do campo de input a esclarecer se deve ser inserido o valor bruto ou líquido.
- Modelo: gemini-3.1-flash-lite

## vida_recorrentes_medio_pt.png — sim
...
- Melhoria: Adicionar uma pequena nota explicativa sobre o que acontece ao clicar em 'Como cancelar' para clarificar se é um processo automático ou apenas informativo.
- Modelo: gemini-3.1-flash-lite

## vida_recorrentes_vazio_medio_pt.png — quase
...
- Melhoria: Adicionar uma pequena nota de segurança ou ícone de cadeado a explicar que a ligação ao banco é segura e apenas para leitura.
- Modelo: gemini-3.1-flash-lite

## vida_sai_cheio_medio_pt.png — quase
...
- Melhoria: Adicionar um botão 'Pagar' ou 'Marcar como pago' dentro de cada conta para tornar a ação imediata e clara.
- Modelo: gemini-3.1-flash-lite

## vida_sai_vazio_medio_pt.png — sim
...
- Melhoria: Alterar o texto do botão 'Nova conta' para 'Adicionar despesa' para evitar confusão com contas bancárias.
- Modelo: gemini-3.1-flash-lite

## vida_sobra_bom_medio_pt.png — quase
...
- Melhoria: Adicionar um botão de ação flutuante (FAB) com um sinal de '+' para permitir adicionar rapidamente uma nova despesa ou receita.
- Modelo: gemini-3.1-flash-lite

## vida_sobra_carregar_medio_pt.png — nao
...
- Melhoria: Adicionar um botão de ação flutuante com um sinal de '+' e uma mensagem de estado vazio a explicar como adicionar o primeiro movimento financeiro.
- Modelo: gemini-3.1-flash-lite
...
- Melhoria: Adicionar botões de ação direta como 'Adicionar rendimento' ou 'Ver despesas' dentro do bloco vermelho para guiar o utilizador na resolução do problema.
- Modelo: gemini-3.1-flash-lite

## vida_sobra_vazio_medio_pt.png — quase
...
- Palavras difíceis: extrato
- Melhoria: Adicionar uma pequena nota de segurança ou um ícone de cadeado junto ao botão 'Importar extrato' para transmitir confiança ao utilizador.
- Modelo: gemini-3.1-flash-lite
