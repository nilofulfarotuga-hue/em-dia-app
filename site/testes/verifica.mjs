...
ok(apagarConta.status === 200 && /<title>Apagar a conta/.test(apagarConta.texto) && /emdia@boraguarda\.com/.test(apagarConta.texto), '/apagar-conta 200 com título e e-mail', `status ${apagarConta.status}`);
